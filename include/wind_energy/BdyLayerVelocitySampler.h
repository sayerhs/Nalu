...
#ifndef BDYLAYERVELOCITYSAMPLER_H
#define BDYLAYERVELOCITYSAMPLER_H
 ...
 *
 */
class BdyLayerVelocitySampler: public AlgorithmDriver
{
public:
  BdyLayerVelocitySampler(
    Realm&,
    WallUserData&);

  virtual ~BdyLayerVelocitySampler();
...
private:
  BdyLayerVelocitySampler() = delete;
  BdyLayerVelocitySampler(const BdyLayerVelocitySampler&) = delete;
...
#endif /* BDYLAYERVELOCITYSAMPLER_H */
